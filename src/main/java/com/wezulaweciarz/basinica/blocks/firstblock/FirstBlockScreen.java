...
public class FirstBlockScreen extends ContainerScreen<FirstBlockContainer> {
    ...
    private ResourceLocation GUI = new ResourceLocation(Basinica.MODID, "textures/gui/gui_gen.png");
    ...
    protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
        this.font.drawString(this.title.getFormattedText(), 8.0F, (float)(this.ySize - 96 +2), 4210752);
    }
